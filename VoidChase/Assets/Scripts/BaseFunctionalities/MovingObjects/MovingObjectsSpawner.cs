...
{
	public class MovingObjectsSpawner <TPool, TObject> : MonoBehaviour
		where TPool : MovingObjectsPool<TObject> 
		where TObject : MovingObjectController
	{
		[field: SerializeField]
		private TPool CurrentObjectsPool { get; set; }
		[field: SerializeField]
		...
		private void SpawnMovingObjects ()
		{
			...
			if (CanSpawnMovingObject())
			{
				...
				TObject projectile = CurrentObjectsPool.Get();
